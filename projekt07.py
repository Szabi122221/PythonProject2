...
def dobas(dobasok):
    ...
    #eredmeny_cimke_szovege.set(str(szam))
...
def on_dobas():
    try:
        ...
        messagebox.showerror("Error", "Rossz érték!")
...
dobasszam = tk.Entry(root, font=("Arial", 16), textvariable=dobasok_szama_bemenet, width=10)
